...
class modelGestionEscalonamiento
{
    ...
    public function gestionEscalonamiento()
    {
        ...
        try {
            ...
            $stmt = $this->_BD->query("SELECT e.pedido, e.tarea, e.tecnico, e.id_tecnico, e.fecha_solicitud, e.fecha_gestion, e.login_gestion, e.engestion, e.proceso, e.producto, e.motivo, 
