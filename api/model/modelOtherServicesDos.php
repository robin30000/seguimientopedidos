    ...
    public function csvContingencias($data)
    {
        try {
            ...
            $stmt = $this->_DB->prepare("SELECT C.accion,
                                                 ...
                                                 C.macSale,
                                                 C.motivo,
                                                 REPLACE(C.observacion, CHAR(10), '.') as observacion,
                                                 C.paquetes,
                                                 C.pedido,
                                                 C.proceso,
                                                 C.producto,
                                                 ...
                                                 C.horagestion,
                                                 C.horacontingencia,
                                                 REPLACE(C.observContingencia, CHAR(10), '.') as observContingencia,
                                                 C.acepta,
                                                 C.tipificacion,
                                                 C.fechaClickMarca,
                                                 ...
                                                 REPLACE(C.observContingenciaPortafolio, CHAR(10), '.')as observContingenciaPortafolio,
                                                 C.generarcr
