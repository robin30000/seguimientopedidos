	...
	*/
    ...
    private function listadoUsuarios()
    {
        ...
        if ($rst->num_rows > 0) {
            ...
            $this->response($this->json([$resultado, $counter]), 201);
    ...
    private function diferenciasClick()
    {
        ...
        if ($rst->num_rows > 0) {
            ...
            $this->response($this->json([$resultado, $total_actual, $total_anterior]), 201);
    ...
    private function ciudades()
    {
        ...
        if ($rst->num_rows > 0) {
            ...
            $this->response($this->json([$resultado, $resultadodepa]), 201);
    ...
    private function buscaregistros()
    {
        ...
        if ($rst->num_rows > 0 || $rstagendamiento->num_rows > 0 || $rstseguiclcik->num_rows > 0) {
            ...
            $this->response($this->json([$resultado, $counteragenda, $counterClick, $resultadoagenda, $resultadosclick]), 201);
    ...
    private function csvGeneracionTT()
    {
        ...
        if ($rst->num_rows > 0) {
            ...
            $this->response($this->json([$filename, $counter]), 200);
        }
    ...
    private function cargar_datos()
    {
        ...
        [$start, $start_h, $start_v] = $rslt;
        if (!preg_match('#([A-Z]+)([0-9]+)#', $end, $rslt)) {
            return false;
        }
        [$end, $end_h, $end_v] = $rslt;
    ...
    private function graficaDepartamento()
    {
        ...
        if ($rst->num_rows > 0) {
            ...
            $this->response($this->json([$departamentos]), 201);
        } else {
            $error = [];
    ...
    private function DepartamentosContratos()
    {
        ...
        if ($dptoContrato->num_rows > 0) {
            ...
            $this->response($this->json([$resultadodptoContrato, $dptos, $eia, $conavances, $eagle, $emt, $rye, $servtek, $contratos]), 201);
    ...
    private function graficaAcumulados()
    {
        ...
        if ($rstMeses->num_rows > 0) {
            ...
            $this->response($this->json([$categorias, $total, $porcentaje, $acumulado, $mes, $meta]), 201);
        } else {
            $error = [];
    ...
    private function garantiasInstalaciones()
    {
        ...
        if ($rst->num_rows > 0) {
            ...
            if ($rstTecnicos->num_rows > 0) {
                ...
                while ($row = $rstTecnicos->fetch_assoc()) {
                    ...
                    if ($row['Total'] == 'Mayores a 30') {
                        $May30 = $May30 + 1;
                    } elseif ($row['Total'] == 'Entre 20-29') {
                        $Entre20_29 = $Entre20_29 + 1;
                    } elseif ($row['Total'] == 'Entre 15-19') {
                        $Entre15_19 = $Entre15_19 + 1;
                    } elseif ($row['Total'] == 'Entre 10-14') {
            ...
            $this->response($this->json([$resultado, $Rangostecnicos, $RangosCausas]), 201);
        } else {
            $error = [];
    ...
    private function csvContingencias()
    {
        ...
        if ($rst->num_rows > 0) {
            ...
            $this->response($this->json([$filename]), 200);
        }
        $this->response('', 203); // If no records "No Content" status
    ...
    private function insertData()
    {
        ...
        if ($rst->num_rows > 0) {
            ...
            $this->response($this->json([$resultado, $resultado2, $resultado3, $fecha, $click, $agendados, $final_click, $counter]), 201);
    ...
    private function csvexportarRRHH()
    {
        ...
        if ($rst->num_rows > 0) {
            ...
            $this->response($this->json([$filename, $rst->num_rows]), 200);
        }
        $this->response('', 203);
    }
    ...
    private function insertarCambioEquipo()
    {
        ...
        $this->response($this->json([$counter]), 200);
    ...
    private function pendiBrutal()
    {
        ...
        while ($row = $rstpendientesBrutal->fetch_assoc()) {
            ...
            if ($row1 = $rstbusqueda->fetch_assoc()) {
                ...
                $pedidospendi[] = ["pedido" => "$pedido_id"];
            } else {
                //$pedidospendiNO[] = array("pedido" => "$pedido_id", "pendiente" => "$pendiente", "departamento" => "$departamento", "observacion" => "$observacion");
                $pedidospendi[] = ["pedido" => "$pedido_id", "pendiente" => "$pendiente", "departamento" => "$departamento", "observacion" => "$observacion"];
            }
        }
        $this->response($this->json([$pedidospendi]), 201);
    }
    ...
    private function DashBoard()
    {
        ...
        $this->response($this->json([$enGestion, $Sin_gestion, $Escalados, $Pendiente_analisis, $EscaladosCalidad, $enGestionCalidad, $resultadoAsesoresCalidad]), 201);
    }
    ...
    private function gestionFinal()
    {
        ...
        if ($rstAsesores->num_rows > 0) {
            ...
            $this->response($this->json([$resultado, $resultadoAsesores]), 201);
        } else {
            $error = [];
    ...
    private function datoscontingencias()
    {
        ...
        if ($rst->num_rows > 0) {
            ...
            $this->response($this->json([$resultadoTV, $resultadoOTROS, $resultadoPORTAFOLIO]), 201);
    ...
    private function guardarescalamiento()
    {
        ...
        if ($rst->num_rows > 0) {
            ...
            $this->response($this->json([$id]), 200);
        }
    }
    ...
    private function marca()
    {
        ...
        if ($rst->num_rows > 0) {
            ...
            if ($login == $logincontingencia) {
                ...
                $this->connseguimiento->query($sqlupdate);
                $this->response($this->json(["desbloqueado"]), 200);
            } else {
    ...
    private function getSoporteGponByTask()
    {
        ...
        $this->response($this->json([$rst]), 201);
        die();
        ...
        if ($rst->num_rows > 0) {
            ...
            $this->response($this->json([$resultSoporteGpon]), 201);
    ...
    private function postPendientesSoporteGpon()
    {
        ...
        $query  = "SELECT * FROM soporte_gpon WHERE tarea = '$task' AND fecha_creado BETWEEN '$hoy 00:00:00' AND '$hoy 23:59:59' AND status_soporte = '0' ";
        ...
        if ($select->num_rows == 0) {
            ...
            if ($insert === true) {
                $this->response($this->json(['type' => 'success', 'msg' => 'OK']), 201);
            } else {
                $this->response($this->json(['type' => 'Error', 'msg' => $this->connseguimiento->error]), 400);
            }
            ...
            if ($update === true) {
                $this->response($this->json(['type' => 'success', 'msg' => 'OK', 'query' => $query]), 201);
            } else {
                $this->response($this->json(['type' => 'Error', 'msg' => $this->connseguimiento->error]), 400);
            }
        }
    ...
    private function getListaPendientesSoporteGpon()
    {
        ...
        /*LOGICA QUE LLEVA LA INFORMACION A TV, INTERNET-ToIp Y CORREGIR PORTAFOLIO*/
        $query = ("SELECT * FROM soporte_gpon WHERE fecha_creado BETWEEN '$hoy 00:00:00' AND '$hoy 23:59:59' AND status_soporte = '0'");
