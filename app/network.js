(function () {
    "use strict";
    angular.module("seguimientopedidos").controller("NetworkCtrl", NetworkCtrl);
    NetworkCtrl.$inject = ["$scope", "$rootScope", "services", "$route", "$sce", "$cookies", "$location", "$uibModal", "$log", "$interval", "$timeout"];

    function NetworkCtrl($scope, $rootScope, services, $route, $sce, $cookies, $location, $uibModal, $log, $interval, $timeout) {
        ...
        function cierreMasivo() {
            services.myService('', 'networkCtrl.php', 'cierreMasivo').then((data) => {
        ...
        function cierreIndividual() {
            services.myService('', 'networkCtrl.php', 'cierreIndividual').then((data) => {
        ...
        function registros(data) {
            ...
            services.myService(datos, 'networkCtrl.php', 'registros').then((data) => {
