(function () {
    "use strict";
    angular.module("seguimientopedidos").controller("GraficoEtpCtrl", GraficoEtpCtrl);
    GraficoEtpCtrl.$inject = ["$scope", "$http", "$rootScope", "$route", "services", "$filter"];

    function GraficoEtpCtrl($scope, $http, $rootScope, $route, services) {
        ...
        function graphic(data) {
            ...
            services.myService(datos, 'etpCtrl.php', 'graphic')
                .then((respuestas) => {
        ...
        function graphicDetails(data) {
            ...
            services.myService(datos, 'etpCtrl.php', 'graphicDetails')
                .then((respuestas) => {
                    if (respuestas.data.state) {
        ...
        function gestionPorHora(data) {
            ...
            services.myService(datos, 'etpCtrl.php', 'gestionPorHora').then((data) => {
                $scope.loading = 0;
