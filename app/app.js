...
app.factory("services", [
    ...
    function ($http, $q, $timeout) {
        ...
        */
        ...
        obj.datosVentasTerminado = function (datos) {
            var data = {
...
app.controller(
    "actividadesCtrl",
    function ($scope, $http, $rootScope, $route, $timeout, services) {
        ...
        $scope.usuarios = function (editarUser) {
            ...
            if (editarUser.PASSWORD == "") {
                ...
                services.editarUsuario(editarUser).then(
                    function (data) {
                        $scope.respuesta =
                            "Usuario " + editarUser.LOGIN + " actualizado exitosamente";
                        $scope.update = true;
                        return data.data;
                    },
        ...
        $scope.calcularSubAcciones = function () {
            $scope.listadoSubAcciones = {};
            if (
                $scope.gestionmanual.proceso == "Plan rescate" &&
                ($scope.gestionmanual.accion == "Pendiente" ||
                    $scope.gestionmanual.accion == "Incompleto")
            ) {
                $scope.validarsubaccion = true;
                $scope.listadoSubAcciones = [
                    {
                        ID: "1011 - Fuera de cobertura",
                        SUBACCION: "1011 - Fuera de cobertura",
                    },
                    { ID: "1019 - Mala asesoria", SUBACCION: "1019 - Mala asesoria" },
                    {
                        ID: "1020 - Incumplimiento contratista",
                        SUBACCION: "1020 - Incumplimiento contratista",
                    },
                    {
                        ID: "1021 - Imposibilidad técnica",
                        SUBACCION: "1021 - Imposibilidad técnica",
                    },
                    { ID: "1022 - Tap copado", SUBACCION: "1022 - Tap copado" },
                    {
                        ID: "1025 - Cliente no desea",
                        SUBACCION: "1025 - Cliente no desea",
                    },
                    { ID: "1026 - Casa sola", SUBACCION: "1026 - Casa sola" },
                    {
                        ID: "1028 - Aplazada por cliente",
                        SUBACCION: "1028 - Aplazada por cliente",
                    },
                    {
                        ID: "1209 - Zona de invasión",
                        SUBACCION: "1209 - Zona de invasión",
                    },
                    {
                        ID: "1217 - Equipo no engancha",
                        SUBACCION: "1217 - Equipo no engancha",
                    },
                    {
                        ID: "1505 - Dirección errada",
                        SUBACCION: "1505 - Dirección errada",
                    },
                    {
                        ID: "1506 - Cliente solicitó otro producto",
                        SUBACCION: "1506 - Cliente solicitó otro producto",
                    },
                    {
                        ID: "1508 - Ductos obstruídos",
                        SUBACCION: "1508 - Ductos obstruídos",
                    },
                    {
                        ID: "1510 - Cliente no contactado",
                        SUBACCION: "1510 - Cliente no contactado",
                    },
                    {
                        ID: "2898 - Requiere visita supervisor ETP",
                        SUBACCION: "2898 - Requiere visita supervisor ETP",
                    },
                    {
                        ID: "2899 - Aplazada por lluvia",
                        SUBACCION: "2899 - Aplazada por lluvia",
                    },
                    {
                        ID: "8383 - Problemas plataformas",
                        SUBACCION: "8383 - Problemas plataformas",
                    },
                    {
                    ...
                    {
                        ID: "O-02 - Pendiente cliente no autoriza",
                        SUBACCION: "O-02 - Pendiente cliente no autoriza",
                    },
                    {
                        ID: "O-06 - Gestión de instalaciones",
                        SUBACCION: "O-06 - Gestión de instalaciones",
                    },
                    {
                        ID: "O-09 - Pendiente por porteria madera",
                        SUBACCION: "O-09 - Pendiente por porteria madera",
                    },
                    {
                    ...
                    {
                        ID: "O-13 - Red pendiente en exteriores",
                        SUBACCION: "O-13 - Red pendiente en exteriores",
                    },
                    {
                        ID: "O-14 - Ped solicitud repetida",
                        SUBACCION: "O-14 - Ped solicitud repetida",
                    },
                    {
                        ID: "O-15 - Pendiente por mala asignación",
                        SUBACCION: "O-15 - Pendiente por mala asignación",
                    },
                    {
                    ...
                    {
                        ID: "O-49 - No desea el servicio",
                        SUBACCION: "O-49 - No desea el servicio",
                    },
                    {
                        ID: "O-50 - Cliente ilocalizado",
                        SUBACCION: "O-50 - Cliente ilocalizado",
                    },
                    {
                    ...
                    {
                        ID: "O-53 - Inconsistencia información",
                        SUBACCION: "O-53 - Inconsistencia información",
                    },
                    {
                        ID: "O-69 - Pen cliente no contactado",
                        SUBACCION: "O-69 - Pen cliente no contactado",
                    },
                    {
                        ID: "O-85 - Red externa pendiente",
                        SUBACCION: "O-85 - Red externa pendiente",
                    },
                    {
                        ID: "O-86 - Pendiente por nodo xdsl",
                        SUBACCION: "O-86 - Pendiente por nodo xdsl",
                    },
                    {
                    ...
                    {
                        ID: "OT-C01 - Cliente no autoriza",
                        SUBACCION: "OT-C01 - Cliente no autoriza",
                    },
                    { ID: "OT-C04 - Orden público", SUBACCION: "OT-C04 - Orden público" },
                    {
                        ID: "OT-C08 - Reconfigurar pedido",
                        SUBACCION: "OT-C08 - Reconfigurar pedido",
                    },
                    {
                        ID: "OT-C10 - Validar condición instalación",
                        SUBACCION: "OT-C10 - Validar condición instalación",
                    },
                    {
                        ID: "OT-C12 - Reconfigurar motivo técnico",
                        SUBACCION: "OT-C12 - Reconfigurar motivo técnico",
                    },
                    {
                        ID: "OT-C14 - Orden del suscriptor",
                        SUBACCION: "OT-C14 - Orden del suscriptor",
                    },
                    {
                        ID: "OT-C17 - Autorización de terceros",
                        SUBACCION: "OT-C17 - Autorización de terceros",
                    },
                    {
                        ID: "OT-C19 - Factores climáticos",
                        SUBACCION: "OT-C19 - Factores climáticos",
                    },
                    {
                        ID: "OT-T01 - Red pendiente edif y urb",
                        SUBACCION: "OT-T01 - Red pendiente edif y urb",
                    },
                    { ID: "OT-T04 - Red externa", SUBACCION: "OT-T04 - Red externa" },
                    {
                        ID: "OT-T05 - Mala asignación",
                        SUBACCION: "OT-T05 - Mala asignación",
                    },
                    {
                        ID: "OT-T10 - Reparación de red externa",
                        SUBACCION: "OT-T10 - Reparación de red externa",
                    },
                    ...
                    {
                        ID: "O-23 - Pendiente no contestan",
                        SUBACCION: "O-23 - Pendiente no contestan",
                    },
                    {
                        ID: "OT-C02 - Cliente ilocalizado",
                        SUBACCION: "OT-C02 - Cliente ilocalizado",
                    },
                    {
                        ID: "OT-C06 - Inconsistencia información",
                        SUBACCION: "OT-C06 - Inconsistencia información",
                    },
                    {
                        ID: "OT-T02 - Gestión de instalaciones",
                        SUBACCION: "OT-T02 - Gestión de instalaciones",
                    },
                    {
                    ...
                    {
                        ID: "OT-T19 - Plataforma caída",
                        SUBACCION: "OT-T19 - Plataforma caída",
                    },
                    { ID: "1014 - Poste averiado", SUBACCION: "1014 - Poste averiado" },
                    { ID: "O-24 - Pendi postería", SUBACCION: "O-24 - Pendi postería" },
                    {
                        ID: "OT-C05 - Gestión fraudes instalaciones",
                        SUBACCION: "OT-C05 - Gestión fraudes instalaciones",
                    },
                    {
                        ID: "OT-C11 - Cancelar motivo técnico",
                        SUBACCION: "OT-C11 - Cancelar motivo técnico",
                    },
                    {
                        ID: "OT-T17 - Solución con proyecto",
                        SUBACCION: "OT-T17 - Solución con proyecto",
                    },
                ];
            } else {
                services
                    .getSubAcciones(
                        $scope.gestionmanual.proceso,
                        $scope.gestionmanual.accion
                    )
                    .then(
                        function (data) {
                            if (data.data.state != 1) {
        ...
        $scope.calcularCodigos = function () {
            ...
            services
                .getCodigos(
                    $scope.gestionmanual.proceso,
                    $scope.gestionmanual.UNESourceSystem
                )
                .then(
                    function (data) {
                        if (data.data.state != 1) {
        ...
        $scope.mostrarModal = function () {
            if ($scope.infopedido == true) {
                ...
                if (
                    $scope.gestionmanual.producto != "" &&
                    $scope.gestionmanual.producto != undefined
                ) {
            ...
            if (producto.indexOf("HFC") !== -1) {
                ...
                producto.indexOf("ADSL") !== -1 ||
                producto.indexOf("REDCO") !== -1 ||
                producto.indexOf("Telefonia_Basica") !== -1
            ) {
                var tecnologia = "ADSL";
            ...
            if ($scope.gestionmanual.accion == "Registrar materiales") {
                $scope.materiales = [
                    { id: "1", tipoCable: "No uso", inicio: "", fin: "" },
                ];
            ...
            if (
                tecnologia == "HFC" &&
                ($scope.gestionmanual.subAccion == "INFRAESTRUCTURA HFC" ||
                    $scope.gestionmanual.subAccion ==
                    "O-112 Pendiente Por Reparacion de Red")
            ) {
                ...
                tecnologia == "ADSL" &&
                ($scope.gestionmanual.subAccion == "INFRAESTRUCTURA COBRE" ||
                    $scope.gestionmanual.subAccion ==
                    "O-112 Pendiente Por Reparacion de Red")
            ) {
            ...
            if (
                $scope.gestionmanual.subAccion == "Cumple parametros de instalacion" ||
                $scope.gestionmanual.subAccion == "Cumple parametros de reparacion"
            ) {
                if (tecnologia == "LTE" || tecnologia == "DTH") {
                    alert(
                        "Para los productos DTH y LTE no aplica cumplir con parametros"
                    );
                    return;
                } else if (
                    $scope.gestionmanual.CIUDAD == "MESA DE AYUDA" ||
                    $scope.gestionmanual.CIUDAD == "MIGRACIONES" ||
                    $scope.gestionmanual.CIUDAD == "TECNICOS DE APOYO"
                ) {
                    alert(
                        "Para los despachos Mesa, migraciones y técnicos de apoyo no aplica cumplir con parametros"
                    );
                    return;
                } else {
                    if (
                    ...
                    var tech = "";
                    if (
                        $scope.myWelcome.uNETecnologias != "" &&
                        $scope.myWelcome.uNETecnologias != undefined
                    ) {
            ...
            if (
                $scope.gestionmanual.accion == "Cumplir" &&
                $scope.gestionmanual.subAccion == "Recoger Equipos"
            ) {
            ...
            if (
                tecnologia == "HFC" &&
                $scope.gestionmanual.subAccion == "OT-T10-Reparacion de red externa"
            ) {
                if (producto == undefined) {
                    alert("Por favor seleccione el producto");
                    return;
        ...
        $scope.guardarModal = function (materiales) {
            ...
            if ($scope.OpenModal == "CambioEquipoDTH") {
                $scope.observacion =
                    "Cuenta Domiciliaria: " +
                    $scope.equipoDTH.cuenta +
                    ", ID Cuenta: " +
                    $scope.equipoDTH.IdCuenta +
                    ", Motivo: " +
                    $scope.equipoDTH.motivoCambio +
                    ", Chip ID Entra: " +
                    $scope.equipoDTH.chipEntra +
                    ", Chip ID Sale: " +
                    $scope.equipoDTH.chipSale +
                    ", SmartCard Entra: " +
                    $scope.equipoDTH.SmartEntra +
                    ", SmartCard Sale: " +
                    $scope.equipoDTH.SmartSale;

                services
                    .insertarCambioEquipo("DTH", $scope.equipoDTH, $scope.pedido)
                    .then(function (data) {
                        if (data.data.state != 1) {
                            Swal({
                                type: 'error',
            ...
            if ($scope.OpenModal == "CambioEquipoHFC") {
                $scope.observacion =
                    "Cuenta Domiciliaria: " +
                    $scope.equipoHFC.cuenta +
                    ", ID Cuenta: " +
                    $scope.equipoHFC.IdCuenta +
                    ", Servicio: " +
                    $scope.equipoHFC.servicio +
                    ", Motivo: " +
                    $scope.equipoHFC.motivoCambio +
                    ", Equipo Entra: " +
                    $scope.equipoHFC.equipoEntra +
                    ", Equipo Sale: " +
                    $scope.equipoHFC.equipoSale +
                    ", MAC Entra: " +
                    $scope.equipoHFC.macEntra +
                    ", MAC Sale: " +
                    $scope.equipoHFC.macSale;

                services
                    .insertarCambioEquipo("HFC", $scope.equipoHFC, $scope.pedido)
                    .then(function (data) {
                        if (data.data.state != 1) {
                            Swal({
                                type: 'error',
            ...
            if ($scope.OpenModal == "CambioEquipoOtros") {
                $scope.observacion =
                    "Motivo del cambio: " +
                    $scope.equipoOtros.motivoCambio +
                    ", Serial sale: " +
                    $scope.equipoOtros.Serialsale +
                    ", Serial entra: " +
                    $scope.equipoOtros.Serialentra +
                    ", Marca sale: " +
                    $scope.equipoOtros.Marcasale +
                    ", Marca entra: " +
                    $scope.equipoOtros.Marcaentra +
                    ", Referencia sale: " +
                    $scope.equipoOtros.Refentra +
                    ", Referencia entra: " +
                    $scope.equipoOtros.Refsale;

                services
                    .insertarCambioEquipo("ADSL", $scope.equipoOtros, $scope.pedido)
                    .then(function (data) {
                        if (data.data.state != 1) {
                            Swal({
                                type: 'error',
            ...
            if ($scope.OpenModal == "PendiInfraHFC") {
                if (
                    ...
                    $scope.gestionmanual.producto == "HFC-ToIP" ||
                    $scope.gestionmanual.producto == "HFC-TV_Digital"
                ) {
                    ...
                    $scope.observacion =
                        ...
                        $scope.pendiInfraTvBas.repaProvisional +
                        ", RF canal 2: " +
                        $scope.pendiInfraTvBas.RF2 +
                        ", RF canal 110: " +
                        $scope.pendiInfraTvBas.RF110 +
                        ", Ciudad: " +
                        $scope.pendiInfraTvBas.Ciudad +
                        ", Celular: " +
                        $scope.pendiInfraTvBas.Celular +
                        ", Técnico: " +
                        $scope.pendiInfraTvBas.nomTecnico +
                        ", Observaciones: " +
                        $scope.pendiInfraTvBas.observaciones;
                }
            }
            ...
            if ($scope.OpenModal == "ContingenciaDTH") {
                ...
                if ($scope.contingenciaDTH.aprovi != undefined) {
                    $scope.observacion +=
                        "-Deco TV Digital por " +
                        $scope.contingenciaDTH.aprovi +
                        " con el Chip ID " +
                        $scope.contingenciaDTH.chip +
                        " y SmartCard " +
                        $scope.contingenciaDTH.smart;
                }

                if ($scope.contingenciaDTH.aprovi2 != undefined) {
                    $scope.observacion +=
                        "-Deco TV Digital por " +
                        $scope.contingenciaDTH.aprovi2 +
                        " con el Chip ID " +
                        $scope.contingenciaDTH.chip2 +
                        " y SmartCard " +
                        $scope.contingenciaDTH.smart2;
                }

                if ($scope.contingenciaDTH.aprovi3 != undefined) {
                    $scope.observacion +=
                        "-Deco TV Digital por " +
                        $scope.contingenciaDTH.aprovi3 +
                        " con el Chip ID " +
                        $scope.contingenciaDTH.chip3 +
                        " y SmartCard " +
                        $scope.contingenciaDTH.smart3;
                }

                if ($scope.contingenciaDTH.aprovi4 != undefined) {
                    $scope.observacion +=
                        "-Deco TV Digital por " +
                        $scope.contingenciaDTH.aprovi4 +
                        " con el Chip ID " +
                        $scope.contingenciaDTH.chip4 +
                        " y SmartCard " +
                        $scope.contingenciaDTH.smart4;
                }

                if ($scope.contingenciaDTH.observaciones != undefined) {
                    $scope.observacion +=
                        "-Queda en pediente: " +
                        $scope.contingenciaDTH.observaciones +
                        "--";
                }
            }
            ...
            if ($scope.OpenModal == "ContingenciaOtros") {
                ...
                if ($scope.contingenciaNCA.aproviInternet != undefined) {
                    $scope.observacion +=
                        "-Internet por " +
                        $scope.contingenciaNCA.aproviInternet +
                        " con la MAC " +
                        $scope.contingenciaNCA.MACinternet;
                }

                if ($scope.contingenciaNCA.aproviToIP != undefined) {
                    $scope.observacion +=
                        "-ToIP por " +
                        $scope.contingenciaNCA.aproviToIP +
                        " con la MAC " +
                        $scope.contingenciaNCA.MACToIP;
                }

                if ($scope.contingenciaNCA.aprovi1 != undefined) {
                    $scope.observacion +=
                        "-Deco TV Digital por " +
                        $scope.contingenciaNCA.aprovi1 +
                        " con la MAC " +
                        $scope.contingenciaNCA.MACTV1;
                }

                if ($scope.contingenciaNCA.aprovi2 != undefined) {
                    $scope.observacion +=
                        "-Deco TV Digital por " +
                        $scope.contingenciaNCA.aprovi2 +
                        " con la MAC " +
                        $scope.contingenciaNCA.MACTV2;
                }

                if ($scope.contingenciaNCA.aprovi3 != undefined) {
                    $scope.observacion +=
                        "-Deco TV Digital por " +
                        $scope.contingenciaNCA.aprovi3 +
                        " con la MAC " +
                        $scope.contingenciaNCA.MACTV3;
                }

                if ($scope.contingenciaNCA.aprovi4 != undefined) {
                    $scope.observacion +=
                        "-Deco TV Digital por " +
                        $scope.contingenciaNCA.aprovi4 +
                        " con la MAC " +
                        $scope.contingenciaNCA.MACTV4;
                }

                if ($scope.contingenciaNCA.aprovi5 != undefined) {
                    $scope.observacion +=
                        "-Deco TV Digital por " +
                        $scope.contingenciaNCA.aprovi5 +
                        " con la MAC " +
                        $scope.contingenciaNCA.MACTV5;
                }

                if ($scope.contingenciaNCA.aprovi6 != undefined) {
                    $scope.observacion +=
                        "-Deco TV Digital por " +
                        $scope.contingenciaNCA.aprovi6 +
                        " con la MAC " +
                        $scope.contingenciaNCA.MACTV6;
                }

                if ($scope.contingenciaNCA.observaciones != undefined) {
                    $scope.observacion +=
                        "-Queda en pediente: " +
                        $scope.contingenciaNCA.observaciones +
                        "--";
                }
            }
            ...
            if ($scope.OpenModal == "cumplirInstalacionHFC") {
                ...
                if (
                    $scope.cumplir.sinalarmas != undefined &&
                    $scope.cumplir.sinalarmas
                ) {
                    diagnostico = "0";
                } else {
                    if (
                        $scope.cumplir.potenciaup != undefined &&
                        $scope.cumplir.potenciaup
                    )
                        diagnostico = "1";
                    if ($scope.cumplir.snrup != undefined && $scope.cumplir.snrup)
                        diagnostico = diagnostico + "/2";
                    if (
                        $scope.cumplir.potenciadown != undefined &&
                        $scope.cumplir.potenciadown
                    )
                        diagnostico = diagnostico + "/3";
                    if ($scope.cumplir.snrdown != undefined && $scope.cumplir.snrdown)
                        diagnostico = diagnostico + "/4";
                    if (
                        $scope.cumplir.paquetesnocorregidosup != undefined &&
                        $scope.cumplir.paquetesnocorregidosup
                    )
                        diagnostico = diagnostico + "/5";
                    if (
                        $scope.cumplir.paquetesnocorregidosdown != undefined &&
                        $scope.cumplir.paquetesnocorregidosdown
                    )
                        diagnostico = diagnostico + "/6";
                    if (
                        $scope.cumplir.modoparcialenportadoras != undefined &&
                        $scope.cumplir.modoparcialenportadoras
                    )
                        diagnostico = diagnostico + "/7";
                    if (
                        $scope.cumplir.ajustesdepotencia != undefined &&
                        $scope.cumplir.ajustesdepotencia
                    )
                        diagnostico = diagnostico + "/8";
                    if (
                        $scope.cumplir.porcentajemiss != undefined &&
                        $scope.cumplir.porcentajemiss
                    )
                        diagnostico = diagnostico + "/9";
                }

                $scope.observacion =
                    "*TID : " +
                    $scope.cumplir.transaccionid +
                    "*LDAP : " +
                    $scope.cumplir.validacionldap +
                    "*Estado CM : " +
                    $scope.cumplir.estadocm +
                    "*IP Navegación : " +
                    $scope.cumplir.tieneipnavegacion +
                    "*Diagnostico: {" +
                    diagnostico +
                    "}" +
                    "*IP EMTA : " +
                    $scope.cumplir.tieneipemta +
                    "*Archivo de Config : " +
                    $scope.cumplir.tienearchivoconfiguracion +
                    "*Linea registrada : " +
                    $scope.cumplir.registradaims +
                    "*ID Llamada : " +
                    $scope.cumplir.idllamadaentrante +
                    "*Config. Plataforma : " +
                    $scope.cumplir.configuradoplataformatv +
                    "*ONETV : " +
                    $scope.cumplir.esonetv +
                    "*Estado CM Deco : " +
                    $scope.cumplir.estadocmembebido;
            }

            if ($scope.OpenModal == "cumplirInstalacionADSL") {
                $scope.observacion =
                    "*PI: " +
                    $scope.cumplir.pruebaintegrada +
                    "*Est. OSS: " +
                    $scope.cumplir.oss +
                    "*Est. Acce: " +
                    $scope.cumplir.acceso +
                    "*Est. CPE: " +
                    $scope.cumplir.cpe +
                    "*Est. Plata: " +
                    $scope.cumplir.plataformas;
            }

            if ($scope.OpenModal == "ContingenciaNormal") {
                $scope.observacion =
                    "Reutilizó equipos? " +
                    $scope.contingenciaNormal.reuEquipos +
                    ", Equipo aprovisionado: " +
                    $scope.contingenciaNormal.equipo;
            }
            ...
            if ($scope.OpenModal == "ContingenciaCambio") {
                ...
                $scope.observacion =
                    ...
                    producto +
                    ", CR o Autoriza: " +
                    $scope.contingenciaCambio.autoriza +
                    ", MAC de datos entra: " +
                    $scope.contingenciaCambio.MacdatosEntra +
                    ", MAC de datos sale: " +
                    $scope.contingenciaCambio.MacdatosSale +
                    ", Línea: " +
                    $scope.contingenciaCambio.linea +
                    ", MAC de voz entra: " +
                    $scope.contingenciaCambio.MacvozEntra +
                    ", MAC de voz sale: " +
                    $scope.contingenciaCambio.MacvozSale +
                    ", Deco(s) entra: " +
                    $scope.contingenciaCambio.decoEntra +
                    ", Deco(s) Sale: " +
                    $scope.contingenciaCambio.decoSale +
                    ", Puertos: " +
                    puertos;
            ...
            if ($scope.OpenModal == "ContingenciaNuevo") {
                ...
                $scope.observacion =
                    ...
                    producto +
                    ", CR o Autoriza: " +
                    $scope.contingenciaNuevo.autoriza +
                    ", Decos: " +
                    $scope.contingenciaNuevo.Decos +
                    ", línea: " +
                    $scope.contingenciaNuevo.linea +
                    ", MAC de datos: " +
                    $scope.contingenciaNuevo.MacDatos +
                    ", MAC de voz: " +
                    $scope.contingenciaNuevo.MacVoz;
                console.log($scope.observacion);
            }
            ...
            if ($scope.OpenModal == "ContingenciaReuso") {
                ...
                $scope.observacion =
                    ...
                    producto +
                    ", CR o Autoriza: " +
                    $scope.contingenciaReuso.autoriza +
                    ", MAC de datos: " +
                    $scope.contingenciaReuso.Macdatos +
                    ", MAC de voz: " +
                    $scope.contingenciaReuso.Macvoz +
                    ", Decos: " +
                    $scope.contingenciaReuso.decos +
                    ", Línea: " +
                    $scope.contingenciaReuso.linea +
                    ", Puertos: " +
                    puertos;
            }
        ...
        $scope.guardarModalRecogerEq = function (equiposRecoger) {
            if (
                $scope.gestionmanual.tecnico == "" ||
                $scope.gestionmanual.tecnico == undefined
            ) {
            ...
            services.recogidaEquipos(equiposRecoger).then(
                function (respuesta) {
                    if (respuesta.status == "201" || respuesta.status == "200") {
                        Swal("Los equipos a recoger fueron guardados!", "Bien Hecho");
                    }
                ...
                $http.get($scope.url, { timeout: 2000 }).then(
                    function (data) {
                        ...
                        if ($scope.myWelcome.pEDIDO_UNE == null) {
                            ...
                            $scope.gestionmanual.CIUDAD =
                                $scope.myWelcome.uNEMunicipio.toUpperCase();
                            $scope.BuscarTecnico();
                        }
                        return data.data;
                    },
                    ...
                    function (err) {
                        ...
                        $http.get($scope.url, { timeout: 2000 }).then(
                            ...
                            function (err) {
                                console.log(
                                    "ERROR DE CONEXION: NO PUEDO ALCANZAR EL SERVIDOR!!!"
                                );
                                $scope.infopedido = false;
                                $scope.errorconexion1 = true;
                                $scope.myWelcome = {};
                                $scope.errorconexion =
                                    "No hay conexión con Web Service, ingrese datos manualmente";
                            }
                        );
                    },
                    function errorCallback(response) {
        ...
        $scope.BuscarTecnico = function () {
            ...
            let variable = $scope.gestionmanual.tecnico
            data = { page: 1, size: 15, buscar, variable }
            services
                .listadoTecnicos(data)
                .then(
                    function (data) {
        ...
        $scope.createTecnico = function () {
            services
                .creaTecnico($scope.crearTecnico, $scope.gestionmanual.tecnico)
                .then(
                    function (data) {
                        $scope.BuscarTecnico();
                        return data.data;
        ...
        $scope.guardarPedido = function () {
            ...
            if (
                $scope.gestionmanual.interaccion == "" ||
                $scope.gestionmanual.interaccion == undefined
            ) {
            ...
            if (
                ($scope.gestionmanual.interaccion == "llamada" &&
                    $scope.gestionmanual.id_llamada == "") ||
                ($scope.gestionmanual.interaccion == "llamada" &&
                    $scope.gestionmanual.id_llamada == undefined)
            ) {
            ...
            if (
                $scope.gestionmanual.interaccion == "llamada" &&
                $scope.gestionmanual.id_llamada.length > 40
            ) {
            ...
            if (
                $scope.gestionmanual.proceso == "" ||
                $scope.gestionmanual.proceso == undefined
            ) {
            ...
            if (
                $scope.gestionmanual.accion == "" ||
                $scope.gestionmanual.accion == undefined
            ) {
            ...
            if (
                $scope.gestionmanual.accion == "Soporte GPON" &&
                ($scope.gestionmanual.subAccion == "" ||
                    $scope.gestionmanual.subAccion == undefined)
            ) {
...
app.controller(
    ...
    function ($scope, $http, $rootScope, $route, services) {
        ...
        function dataVentaTerminado(data) {
            ...
            services.datosVentasTerminado(data).then(function (data) {
